...
let intvl1 = let open IntInterval in create 0 2 ;;
let intvl2 = let open IntInterval in create 1 3 ;;
let intvl1_intersect_intvl2 = let open IntInterval in intersect intvl1 intvl2 ;;
